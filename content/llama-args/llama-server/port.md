...
- Подсказка формата из `--help`: `PORT`
- Допустимые значения из `--help`: `не указаны`
- Переменные окружения: `LLAMA_ARG_PORT`
- Значение по умолчанию из `--help`: `8080`
...
```bash
llama-server --model /models/example.gguf --port 1
```
...
- https://github.com/ggml-org/llama.cpp/search?q=--port&type=code
- https://github.com/ggml-org/llama.cpp/issues?q=--port
- https://github.com/ggml-org/llama.cpp/discussions?discussions_q=--port
