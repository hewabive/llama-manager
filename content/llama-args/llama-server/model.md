...
primaryName: "--model"
title: "--model"
summary: "Путь к GGUF-модели, которую должен загрузить экземпляр llama-server."
docStatus: draft
...
```bash
llama-server --model /path/to/value
```
...
- https://github.com/ggml-org/llama.cpp/search?q=--model&type=code
- https://github.com/ggml-org/llama.cpp/issues?q=--model
- https://github.com/ggml-org/llama.cpp/discussions?discussions_q=--model
