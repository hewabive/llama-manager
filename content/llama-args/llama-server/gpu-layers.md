...
title: "--gpu-layers"
summary: "Черновая инженерная справка по --gpu-layers из категории \"Общие параметры\". Назначение, допустимые значения и побочные эффекты нужно подтвердить по исходной справке, коду llama.cpp и тестовому запуску."
docStatus: draft
...
Черновая инженерная справка по --gpu-layers из категории "Общие параметры". Назначение, допустимые значения и побочные эффекты нужно подтвердить по исходной справке, коду llama.cpp и тестовому запуску.
...
- Переменные окружения: `LLAMA_ARG_N_GPU_LAYERS`
...
```bash
llama-server --model /models/example.gguf --gpu-layers value1,value2
```
...
- https://github.com/ggml-org/llama.cpp/search?q=--gpu-layers&type=code
- https://github.com/ggml-org/llama.cpp/issues?q=--gpu-layers
- https://github.com/ggml-org/llama.cpp/discussions?discussions_q=--gpu-layers
