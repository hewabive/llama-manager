...
primaryName: "--ui"
title: "--ui"
summary: "Включить или отключить встроенный Web UI llama-server."
docStatus: draft
...
Включить или отключить встроенный Web UI llama-server.
...
- Переменные окружения: `LLAMA_ARG_UI`
...
```bash
llama-server --model /models/example.gguf --ui true
```
...
- https://github.com/ggml-org/llama.cpp/search?q=--ui&type=code
- https://github.com/ggml-org/llama.cpp/issues?q=--ui
- https://github.com/ggml-org/llama.cpp/discussions?discussions_q=--ui
