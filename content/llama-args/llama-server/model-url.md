...
title: "--model-url"
summary: "Черновая инженерная справка по --model-url из категории \"Общие параметры\". Назначение, допустимые значения и побочные эффекты нужно подтвердить по исходной справке, коду llama.cpp и тестовому запуску."
docStatus: draft
...
Черновая инженерная справка по --model-url из категории "Общие параметры". Назначение, допустимые значения и побочные эффекты нужно подтвердить по исходной справке, коду llama.cpp и тестовому запуску.
...
```bash
llama-server --model /models/example.gguf --model-url value
```
...
- https://github.com/ggml-org/llama.cpp/search?q=--model-url&type=code
- https://github.com/ggml-org/llama.cpp/issues?q=--model-url
- https://github.com/ggml-org/llama.cpp/discussions?discussions_q=--model-url
