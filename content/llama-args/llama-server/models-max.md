...
title: "--models-max"
summary: "Максимум одновременно загруженных моделей в router-режиме. 0 означает без лимита."
docStatus: draft
...
- Переменные окружения: `LLAMA_ARG_MODELS_MAX`
- Значение по умолчанию из `--help`: `4, 0 = unlimited`
...
```bash
llama-server --model /models/example.gguf --models-max 1
```
...
- https://github.com/ggml-org/llama.cpp/search?q=--models-max&type=code
- https://github.com/ggml-org/llama.cpp/issues?q=--models-max
- https://github.com/ggml-org/llama.cpp/discussions?discussions_q=--models-max
