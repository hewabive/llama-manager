...
title: "--cache-type-k"
summary: "Тип данных KV-cache для ключей. Меньшие типы экономят память, но могут влиять на качество/скорость."
docStatus: draft
...
- Переменные окружения: `LLAMA_ARG_CACHE_TYPE_K`
...
```bash
llama-server --model /models/example.gguf --cache-type-k f32
```
...
- https://github.com/ggml-org/llama.cpp/search?q=--cache-type-k&type=code
- https://github.com/ggml-org/llama.cpp/issues?q=--cache-type-k
- https://github.com/ggml-org/llama.cpp/discussions?discussions_q=--cache-type-k
