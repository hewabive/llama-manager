...
title: "--api-prefix"
summary: "Префикс URL без завершающего слеша, если сервер должен жить не в корне HTTP-пути."
docStatus: draft
...
- Подсказка формата из `--help`: `PREFIX`
- Допустимые значения из `--help`: `не указаны`
- Переменные окружения: `LLAMA_ARG_API_PREFIX`
...
```bash
llama-server --model /models/example.gguf --api-prefix value
```
...
- https://github.com/ggml-org/llama.cpp/search?q=--api-prefix&type=code
- https://github.com/ggml-org/llama.cpp/issues?q=--api-prefix
- https://github.com/ggml-org/llama.cpp/discussions?discussions_q=--api-prefix
