...
title: "--api-key-file"
summary: "Файл со списком API-ключей."
docStatus: draft
...
```bash
llama-server --model /models/example.gguf --api-key-file /path/to/value
```
...
- https://github.com/ggml-org/llama.cpp/search?q=--api-key-file&type=code
- https://github.com/ggml-org/llama.cpp/issues?q=--api-key-file
- https://github.com/ggml-org/llama.cpp/discussions?discussions_q=--api-key-file
