...
primaryName: "--api-key"
title: "--api-key"
summary: "API-ключи для аутентификации, можно передать несколько через запятую."
docStatus: draft
...
- Подсказка формата из `--help`: `KEY`
- Допустимые значения из `--help`: `не указаны`
- Переменные окружения: `LLAMA_API_KEY`
...
```bash
llama-server --model /models/example.gguf --api-key value1,value2
```
...
- https://github.com/ggml-org/llama.cpp/search?q=--api-key&type=code
- https://github.com/ggml-org/llama.cpp/issues?q=--api-key
- https://github.com/ggml-org/llama.cpp/discussions?discussions_q=--api-key
