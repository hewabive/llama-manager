...
title: "--tensor-split"
summary: "Доли распределения модели по GPU, например 3,1."
docStatus: draft
...
Доли распределения модели по GPU, например 3,1.
...
- Подсказка формата из `--help`: `N0,N1,N2,...`
- Допустимые значения из `--help`: `не указаны`
- Переменные окружения: `LLAMA_ARG_TENSOR_SPLIT`
...
```bash
llama-server --model /models/example.gguf --tensor-split value1,value2
```
...
- https://github.com/ggml-org/llama.cpp/search?q=--tensor-split&type=code
- https://github.com/ggml-org/llama.cpp/issues?q=--tensor-split
- https://github.com/ggml-org/llama.cpp/discussions?discussions_q=--tensor-split
