...
title: "--models-dir"
summary: "Каталог моделей для router-режима llama-server."
docStatus: draft
...
Каталог моделей для router-режима llama-server.
...
- Переменные окружения: `LLAMA_ARG_MODELS_DIR`
...
```bash
llama-server --model /models/example.gguf --models-dir /path/to/value
```
...
- https://github.com/ggml-org/llama.cpp/search?q=--models-dir&type=code
- https://github.com/ggml-org/llama.cpp/issues?q=--models-dir
- https://github.com/ggml-org/llama.cpp/discussions?discussions_q=--models-dir
