...
title: "--log-file"
summary: "Путь к файлу, куда llama-server будет писать лог."
docStatus: draft
...
Путь к файлу, куда llama-server будет писать лог.
...
- Переменные окружения: `LLAMA_LOG_FILE`
...
```bash
llama-server --model /models/example.gguf --log-file /path/to/value
```
...
- https://github.com/ggml-org/llama.cpp/search?q=--log-file&type=code
- https://github.com/ggml-org/llama.cpp/issues?q=--log-file
- https://github.com/ggml-org/llama.cpp/discussions?discussions_q=--log-file
